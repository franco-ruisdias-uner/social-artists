...
export default function ScheduleSheet(props: Props) {
    ...
    const calcularHora = (minutos: number): Date => {
        const now = new Date();
        const futureDate = new Date(now.getTime() + minutos * 60 * 1000);
        return futureDate;
    }
            ...
            <BottomSheetView style={styles.bottomSheetContentContainer}>
                ...
                <View style={[styles.itemContainer]}>
                    <Pressable
                        ...
                        <Text style={[baseStyles.textBase, styles.innerText]}>Dentro de media hora ({formatTime(dentroDeMediaHora)})</Text>
                    </Pressable>
                    ...
                    <Pressable
                        ...
                        <Text style={[baseStyles.textBase, styles.innerText, { paddingBottom: 0 }]}>Dentro de una hora ({formatTime(dentroDeUnaHora)})</Text>
                    </Pressable>
                </View>
                <LineDivider />
                <Pressable
